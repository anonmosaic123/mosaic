...
def make_env(cfg):
    ...
    elif cfg.env == "mo-halfcheetah-v4":
        env = mo_gymnasium.make("mo-halfcheetah-v4")
    elif cfg.env == "mo-hopper-v4":
        env = mo_gymnasium.make("mo-hopper-v4")
    elif cfg.env == "mo-reacher-v4":
        env = mo_gymnasium.make("mo-reacher-v4")
    else:
